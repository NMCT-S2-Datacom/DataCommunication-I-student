...
# underscore werkt enkel in de python 3.6
...
class Dec2Bin(unittest.TestCase):
    def test_example(self):
        self.assertEqual(255, 0b11111111)
...
class Hex2Bin(unittest.TestCase):
    def test_example(self):
        self.assertEqual(0xff, 0b11111111)

    def test_oef1(self):
        self.assertEquals(0x80, 0b10000000)

    def test_oef2(self):
        self.assertEquals(0x38, 0b00111001)
...
class Bin2Dec(unittest.TestCase):
    ...
    def test_oef1(self):
        self.assertEqual(0b10010011, 147)
    #
    # def test_oef2(self):
...
class Bin2Hex(unittest.TestCase):
    def test_example(self):
        self.assertEqual(0b11111111, 0xff)
